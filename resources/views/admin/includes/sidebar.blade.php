    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" id="myUL">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link @if(request()->is('social_settings'))  active @elseif(request()->is('settings')) active @endif">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('social_settings')}}" class="nav-link {{request()->is('social_settings') ? 'active' : ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Social Settings</p>
                </a>
              </li>
